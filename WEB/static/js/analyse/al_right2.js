//right2 购房价格分布图
//由陈季烨完成绘图，曾培益填补数据
function sz_right2(buyDistr,cityMap) {
    var data = buyDistr
    //cityMap 深圳：[440300,[114.066112,22.548515]]
    var max_data = Math.max.apply(Math, buyDistr.map(function (o) {
        return o.value;
    }));
    var min_data = Math.min.apply(Math, buyDistr.map(function (o) {
        return o.value;
    }));
